...
import {
    ...
    FileText, CheckCheck, X, Send, UserPlus
} from 'lucide-react';
    ...
    return (
        <div className="max-w-[1200px] mx-auto space-y-6">
            ...
            <div className="flex items-start justify-between">
                ...
                {/* Assign Button (for supervisors/owners on unassigned tasks) */}
                ...
                task.assigneeId && (
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs font-bold text-blue-600 dark:text-blue-400">ASSIGNED TO</p>
                                <p className="font-bold text-gray-900 dark:text-white">@{task.assigneeUsername}</p>
                            </div>
                        </div>
                        {/* Only show reassign if supervisor */}
                        {isSupervisor && (
                            <button
                                onClick={() => setShowAssignModal(true)}
