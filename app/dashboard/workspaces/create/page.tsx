    ...
    return (
        <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-zinc-800 p-8">
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            placeholder="e.g. Marketing Projects, Development Team"
            ...
            <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/50 rounded-xl p-6">
                <h3 className="font-bold text-blue-900 dark:text-blue-300 mb-2">💡 What's a Workspace?</h3>
                <p className="text-sm text-blue-800 dark:text-blue-400">
                    Workspaces help you organize multiple projects under one umbrella. You can invite team members,
                    assign roles, and manage all related projects in one place. Perfect for agencies, teams, and departments!
                </p>
            </div>
        </div>
    );
