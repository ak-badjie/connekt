      ...
      <div className="mb-12 relative">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-4">
          ...
          <div>
            ...
            >
              <AnimatedText text="Create Project" />
            </motion.h1>
            <motion.p
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
          ...
          >
            ...
            <div className="bg-gradient-to-br from-[#008080] to-teal-700 rounded-3xl p-6 text-white shadow-2xl shadow-teal-500/20 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-3 relative z-10">
                ...
                <div className={`bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/10 transition-colors ${(walletBalance !== null && parseFloat(formData.budget || '0') > walletBalance) ? 'bg-red-500/20 border-red-400/50' : ''
                  }`}>
                  <p className="text-xs text-teal-100 mb-1">Remaining</p>
                  <p className={`font-bold text-lg flex items-center gap-1 ${(walletBalance !== null && parseFloat(formData.budget || '0') > walletBalance) ? 'text-red-200' : ''
                    }`}>
                    D <CountUp
