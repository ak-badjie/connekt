...
import { AnimatePresence, animate, easeOut, motion, useMotionValue } from "framer-motion";
...
export interface ThreeDImageRingProps {
  ...
  /** Optional click-to-select handler for an image */
            ...
            {showImages && images.map((imageUrl, index) => (
              <motion.div
                ...
                onClick={(e) => {
                  ...
                  if (isDragging.current || didDrag.current) return;
                  e.stopPropagation();
