...
export function MailSidebar({
    ...
    return (
        <div className="w-64 h-[calc(100vh-76px)] bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl border-r border-gray-200/50 dark:border-zinc-800/50 flex flex-col relative">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center justify-between px-4 py-3 rounded-xl font-medium transition-all ${isActive
                                    ? 'bg-gradient-to-r from-[#008080]/10 to-amber-500/10 text-[#008080] border border-[#008080]/20 shadow-sm'
                ...
                <div className="px-3 pb-4">
                    <button
                        ...
                        className="w-full flex items-center justify-between px-3 py-2 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider hover:text-[#008080] transition-colors"
                    >
                            ...
                            >
                                {categories.map((category) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <Folder size={16} className={isActive ? 'text-amber-500' : 'text-gray-400'} />
                                            <span>{category}</span>
                                        </button>
                                    );
                                })}
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="font-bold text-gray-700 dark:text-gray-300">
                            {storageUsed.toFixed(2)}GB / {storageTotal.toFixed(1)}GB
                        </span>
                    </div>
