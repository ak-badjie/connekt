...
export function TopUpModal({ isOpen, onClose, walletId }: TopUpModalProps) {
    const { user } = useAuth();
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder="0.00"
                                            className="w-full pl-14 pr-6 py-5 bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-2xl focus:ring-4 focus:ring-[#008080]/20 focus:border-[#008080] outline-none transition-all font-bold text-3xl"
                                        />
                                    </div>
                                </div>
