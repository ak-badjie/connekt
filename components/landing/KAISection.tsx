...
export default function KAISection({ isVisible }: SectionProps) {
    const color = "rose";
        ...
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16 items-center h-full">
            ...
            >
                ...
                <p className="text-xl text-slate-500 leading-relaxed">
                    The future of hiring is based on what you can do, not where you went to school. Validated skills metric systems for the modern era.
                </p>
            </motion.div>
