...
export default function RecruiterDashboard() {
    ...
    const projectImages = pendingProjects.map((p, i) => ({
        src:
            p.coverImage ||
            `https://images.unsplash.com/photo-${['1522071820081-009f0129c71c', '1600880292203-757bb62b4baf', '1556761175-5973ac0f96fc', '1517245386807-bb43f82c33c4'][i % 4]}?q=80&w=800&auto=format&fit=crop`,
        title: p.title,
