...
export function Sidebar({ agency = null }: SidebarProps) {
    ...
    return (
        <>
            <aside className="fixed left-4 top-4 bottom-4 w-64 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-white/20 dark:border-white/5 flex flex-col p-6 pb-32 z-[110] hidden lg:flex transition-all duration-300 overflow-y-auto rounded-3xl shadow-2xl shadow-black/5">
                {/* Logo Section */}
                ...
                <div className="space-y-1 mb-auto">
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 px-3 py-3 rounded-xl bg-gradient-to-r from-[#008080] to-teal-700 text-white hover:from-[#006666] hover:to-teal-800 transition-all shadow-lg"
                    >
            ...
            {/* Upgrade Modal - Rendered outside sidebar to appear above everything */}
            <UpgradeModal
                isOpen={showUpgradeModal}
                onClose={() => setShowUpgradeModal(false)}
                onSuccess={() => {
                    // Modal will refresh and close automatically
                }}
            />
        </>
    );
